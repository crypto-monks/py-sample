...
sudo docker build -t st3api .
docker tag st3api:latest 707000167678.dkr.ecr.us-east-2.amazonaws.com/st3api:latest
docker push 707000167678.dkr.ecr.us-east-2.amazonaws.com/st3api:latest
